...
export default function Skills() {
  ...
  const skillCategories = [
    {
      ...
      experience: '2+ années',
      skills: [
        { name: 'Python', level: 40, years: 1, projects: 5 },
        { name: 'JavaScript/TypeScript', level: 60, years: 1, projects: 15 },
        { name: 'C/C++', level: 45, years: 1.5, projects: 8 },
        { name: 'Java', level: 55, years: 2, projects: 2 },
        { name: 'React/Vue.js', level: 50, years: 1, projects: 6 },
        { name: 'Node.js/Express', level: 56, years: 2, projects: 7 },
      ],
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'FPGA/VHDL', level: 50, years: 2, projects: 4 },
        { name: 'Raspberry Pi', level: 30, years: 2, projects: 6 },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'DSP', level: 80, years: 3, projects: 4 },
    ...
    },
    {
      ...
      experience: '2+ années',
      skills: [
        { name: 'TCP/IP', level: 50, years: 2, projects: 4 },
        { name: 'Linux/Windows Server', level: 25, years: 2, projects: 5 },
        { name: 'Active Directory', level: 30, years: 1, projects: 3 },
        { name: 'Cisco/Routing', level: 20, years: 1, projects: 2 },
        { name: 'VLANs', level: 60, years: 2, projects: 3 },
        { name: 'VMware', level: 50, years: 1, projects: 2 },
      ],
    ...
    },
    {
      ...
      experience: '3+ années',
      skills: [
        { name: 'PostgreSQL', level: 40, years: 1, projects: 8 },
        { name: 'MySQL', level: 85, years: 3, projects: 15 },
        { name: 'MongoDB', level: 55, years: 2, projects: 5 },
        { name: 'SQL', level: 90, years: 4, projects: 16 },
        { name: 'Redis', level: 20, years: 1, projects: 2 },
      ],
    ...
    },
    {
      ...
      experience: '4+ années',
      skills: [
        { name: 'Git/GitHub', level: 50, years: 4, projects: 20 },
        { name: 'Docker', level: 30, years: 2, projects: 8 },
        { name: 'CI/CD', level: 35, years: 2, projects: 6 },
        { name: 'Agile/Scrum', level: 60, years: 3, projects: 10 },
        { name: 'Testing', level: 65, years: 2, projects: 7 },
      ],
  ...
  const overallStats = [
    { label: 'Années d\'Expérience', value: '1+', icon: Clock, color: 'blue' },
    { label: 'Projets Réalisés', value: '20+', icon: Target, color: 'purple' },
    { label: 'Technologies Maîtrisées', value: '30+', icon: Layers, color: 'green' },
